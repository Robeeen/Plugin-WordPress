<?php
/*
Plugin Name: Sticky Contact Form Button
Description: On Click a floating contact button and opens an modal with any contact form.
Version: 1.0
Author: Shams Khan
...
$fcb_shortcode = get_option( 'fcb_options' )['fcb_field_shortcode']; 
  ...
  echo ' <a href="#fcb-modal" class="fcb-link-button"><i class="fcb-icons"><span style="transform: rotate(90deg);font-size: 15px;padding-top: 28px"><p>Hello</p></span></i></a>';
  ...
  echo ' <div class="new_header">Online Viewing</div>';
  echo ' <div class="top_text"><p>Book an online Viewing!</p><p>Take a detailed look around the property - all without leaving your home!</p><p>You can choose either live video or a virtual tour which you can view any time!</p></div>';
